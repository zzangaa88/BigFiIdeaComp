...
public class ContestDetail extends Activity implements View.OnClickListener{
    ...
    public List<DataObject> dataList(String extra) {
        ...
        if(extra.equals("15")) {
            data.add(new DataObject(R.drawable.bf_contest_15_1));
            data.add(new DataObject(R.drawable.bf_contest_15_2));
        }else if(extra.equals("16")){
            data.add(new DataObject(R.drawable.bf_contest_16_1));
            data.add(new DataObject(R.drawable.bf_contest_16_2));
        }else if(extra.equals("17")){
            data.add(new DataObject(R.drawable.bf_contest_17_1));
            data.add(new DataObject(R.drawable.bf_contest_17_2));
            data.add(new DataObject(R.drawable.bf_contest_17_3));
        }
        return data;
    }
