...
public class EduYearChoice extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edu_year_choice);
    ...
    public void onClick(View v) {
        int getid = v.getId();
        String year;
        intent = new Intent(getApplicationContext(), EduDetail.class);
