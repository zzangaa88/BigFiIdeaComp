...
public class EduDetail extends Activity implements View.OnClickListener{
    ...
    public List<DataObject> dataList(String extra) {
        ...
        if(extra.equals("15")) {
            data.add(new DataObject(R.drawable.bf_edu_15_1));
            data.add(new DataObject(R.drawable.bf_edu_15_2));
        }else if(extra.equals("16")){
            data.add(new DataObject(R.drawable.bf_edu_16_1));
            data.add(new DataObject(R.drawable.bf_edu_16_2));
        }else if(extra.equals("17")){
            data.add(new DataObject(R.drawable.bf_edu_17_1));
            data.add(new DataObject(R.drawable.bf_edu_17_2));
            data.add(new DataObject(R.drawable.bf_edu_17_3));
        }
        return data;
    }
